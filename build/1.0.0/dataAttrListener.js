                ...
                if (e.target.getAttribute('data-survey-option') !== null) {
                  _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
                    ...
                    data: {
                      ...
                      category: this.getAttribute('data-survey-category'),
                      data: {
                        ...JSON.parse(this.getAttribute('data-survey-data')),
...
((window.newfold = window.newfold || {}).Survey = window.newfold.Survey || {}).dataAttrListener = __webpack_exports__;
/******/ })()
;
